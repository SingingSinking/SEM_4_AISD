...
int main() {
    ...
    int num;
    std::cin >> num;
    std::cout << "use Own_database result or Exwiki8? (0/1)  ";
    int ans;
    std::cin >> ans;

    //Enter path to text files
    std::string path = ans ? "C:/Users/555/source/repos/3Lab_AISD/enwiki8.txt" : "C:/Users/555/source/repos/3Lab_AISD/Own_d.txt";
